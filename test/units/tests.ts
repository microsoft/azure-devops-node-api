...
describe('Auth Handlers Units', function () {
    it('cross origin authenthication should be allowed by default in BasicCredentialHandler', async() => {
        const basicAuthHandler = WebApi.getBasicHandler('user', 'password');

        assert(basicAuthHandler['allowCrossOriginAuthentication'] === true);
    });

    it('cross origin authenthication should be allowed by default in BearerCredentialHandler', async() => {
    ...
    it('cross origin authenthication should be allowed by default in PersonalAccessTokenCredentialHandler', async() => {
    ...
    it('cross origin authenthication could be disabled in BasicCredentialHandler', async() => {
    ...
    it('cross origin authenthication could be disabled in BearerCredentialHandler', async() => {
    ...
    it('cross origin authenthication could be disabled in PersonalAccessTokenCredentialHandler', async() => {
