...
export interface IServiceHooksApi extends basem.ClientApiBase {
    ...
    getNotificationTracing(subscriptionId: string): Promise<VSSInterfaces.NotificationTracing>;
    updateNotificationTracing(setParameters: VSSInterfaces.NotificationTracingSetParameters, subscriptionId: string): Promise<VSSInterfaces.NotificationTracing>;
...
export class ServiceHooksApi extends basem.ClientApiBase implements IServiceHooksApi {
    ...
    public async getNotificationTracing(
        ...
        ): Promise<VSSInterfaces.NotificationTracing> {

        return new Promise<VSSInterfaces.NotificationTracing>(async (resolve, reject) => {
            let routeValues: any = {
            ...
            try {
                ...
                let res: restm.IRestResponse<VSSInterfaces.NotificationTracing>;
                res = await this.rest.get<VSSInterfaces.NotificationTracing>(url, options);

                let ret = this.formatResponse(res.result,
                                              VSSInterfaces.TypeInfo.NotificationTracing,
                                              false);
    ...
    /**
     * @param {VSSInterfaces.NotificationTracingSetParameters} setParameters
     * @param {string} subscriptionId
     */
    public async updateNotificationTracing(
        setParameters: VSSInterfaces.NotificationTracingSetParameters,
        subscriptionId: string
        ): Promise<VSSInterfaces.NotificationTracing> {
        ...
        return new Promise<VSSInterfaces.NotificationTracing>(async (resolve, reject) => {
            ...
            try {
                ...
                let res: restm.IRestResponse<VSSInterfaces.NotificationTracing>;
                res = await this.rest.replace<VSSInterfaces.NotificationTracing>(url, setParameters, options);
