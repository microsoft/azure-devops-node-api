...
export interface IWorkApi extends basem.ClientApiBase {
    updateAutomationRule(ruleRequestModel: WorkInterfaces.TeamAutomationRulesSettingsRequestModel, teamContext: TfsCoreInterfaces.TeamContext): Promise<void>;
...
export class WorkApi extends basem.ClientApiBase implements IWorkApi {
    ...
    public async updateAutomationRule(
        ruleRequestModel: WorkInterfaces.TeamAutomationRulesSettingsRequestModel,
        ...
        return new Promise<void>(async (resolve, reject) => {
            ...
            try {
                let verData: vsom.ClientVersioningData = await this.vsoClient.getVersioningData(
                    "7.2-preview.2",
                    "work",
                    "2882c15d-0cb3-43b5-8fb7-db62e09a79db",
                    routeValues);
