...
export class BuildApi extends basem.ClientApiBase implements IBuildApi {
    ...
    public async getBuilds(
        ...
        return new Promise<VSSInterfaces.PagedList<BuildInterfaces.Build>>(async (resolve, reject) => {
            let routeValues: any = {
                project: project
            };
    ...
    public async getBuildChanges(
        ...
        return new Promise<VSSInterfaces.PagedList<BuildInterfaces.Change>>(async (resolve, reject) => {
            let routeValues: any = {
                project: project,
                buildId: buildId
            };
    ...
    public async getDefinitions(
        ...
        return new Promise<VSSInterfaces.PagedList<BuildInterfaces.BuildDefinitionReference>>(async (resolve, reject) => {
            let routeValues: any = {
                project: project
            };
    ...
    public async getBuildGeneralSettings(
        project: string
        ): Promise<BuildInterfaces.PipelineGeneralSettings> {

        return new Promise<BuildInterfaces.PipelineGeneralSettings>(async (resolve, reject) => {
            let routeValues: any = {
                project: project
            };
    ...
    public async updateBuildGeneralSettings(
        newSettings: BuildInterfaces.PipelineGeneralSettings,
        project: string
        ): Promise<BuildInterfaces.PipelineGeneralSettings> {
    ...
    public async getRetentionHistory(
        ...
        ): Promise<BuildInterfaces.BuildRetentionHistory> {

        return new Promise<BuildInterfaces.BuildRetentionHistory>(async (resolve, reject) => {
            let routeValues: any = {
            };
    ...
    public async getRetentionLeasesByMinimalRetentionLeases(
        project: string,
        leasesToFetch: BuildInterfaces.MinimalRetentionLease[]
        ): Promise<BuildInterfaces.RetentionLease[]> {
