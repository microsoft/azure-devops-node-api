...
export interface IWorkItemTrackingApi extends basem.ClientApiBase {
    ...
    queryByWiql(wiql: WorkItemTrackingInterfaces.Wiql, teamContext: TfsInterfaces.TeamContext, onResult: (err: any, statusCode: number, wiql: WorkItemTrackingInterfaces.WorkItemQueryResult) => void): void;
    queryById(id: string, teamContext: TfsInterfaces.TeamContext, onResult: (err: any, statusCode: number, wiql: WorkItemTrackingInterfaces.WorkItemQueryResult) => void): void;
...
export interface IQWorkItemTrackingApi extends basem.QClientApiBase {
    ...
    queryByWiql(wiql: WorkItemTrackingInterfaces.Wiql, teamContext?: TfsInterfaces.TeamContext): Q.Promise<WorkItemTrackingInterfaces.WorkItemQueryResult>;
    queryById(id: string, teamContext?: TfsInterfaces.TeamContext): Q.Promise<WorkItemTrackingInterfaces.WorkItemQueryResult>;
...
export class WorkItemTrackingApi extends basem.ClientApiBase implements IWorkItemTrackingApi {
    ...
    public createAttachment(
        ...
        .then((versioningData: vsom.ClientVersioningData) => {
            ...
            var serializationData = { requestTypeMetadata: NodeJS.TypeInfo.ReadableStream, responseTypeMetadata: WorkItemTrackingInterfaces.TypeInfo.AttachmentReference, responseIsCollection: false };
     ...
     * @param {TfsInterfaces.TeamContext} teamContext - The team context for the operation
    ...
    public queryByWiql(
        ...
        teamContext: TfsInterfaces.TeamContext,
