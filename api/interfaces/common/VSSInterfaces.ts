...
import LicensingInterfaces = require("../common/LicensingInterfaces");
...
export interface ExtensionLicenseData {
    ...
    extensionId: string;
    isFree: boolean;
    minimumRequiredAccessLevel: LicensingInterfaces.VisualStudioOnlineServiceLevel;
    updatedDate: Date;
}
...
TypeInfo.ExtensionLicenseData.fields = {
    ...
    minimumRequiredAccessLevel: {
        typeInfo: LicensingInterfaces.TypeInfo.VisualStudioOnlineServiceLevel
    },
    updatedDate: {
        isDate: true,
    },
