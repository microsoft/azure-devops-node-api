...
export class GitApi extends basem.ClientApiBase implements IGitApi {
    ...
    public getDeletedRepositories(
        project: string,
        onResult: (err: any, statusCode: number, DeletedRepositories: GitInterfaces.GitDeletedRepository[]) => void
        ): void {
    ...
    public createCommitStatus(
        ...
        repositoryId: string,
        project: string,
        onResult: (err: any, statusCode: number, Statuse: GitInterfaces.GitStatus) => void
        ): void {
    ...
    public getStatuses(
        ...
        top: number,
        skip: number,
        onResult: (err: any, statusCode: number, Statuses: GitInterfaces.GitStatus[]) => void
        ): void {
...
export class QGitApi extends basem.QClientApiBase implements IQGitApi {
    ...
    */
    public getDeletedRepositories(
        ...
        this.api.getDeletedRepositories(project, (err: any, statusCode: number, DeletedRepositories: GitInterfaces.GitDeletedRepository[]) => {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    public createCommitStatus(
        ...
        this.api.createCommitStatus(gitCommitStatusToCreate, commitId, repositoryId, project, (err: any, statusCode: number, Statuse: GitInterfaces.GitStatus) => {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    public getStatuses(
        ...
        this.api.getStatuses(commitId, repositoryId, project, top, skip, (err: any, statusCode: number, Statuses: GitInterfaces.GitStatus[]) => {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
