...
export interface ITaskAgentApiBase extends basem.ClientApiBase {
    ...
    getAgentRequestsForDeploymentTargets(project: string, deploymentGroupId: number, targetIds?: number[], completedRequestCount?: number): Promise<TaskAgentInterfaces.TaskAgentJobRequest[]>;
    ...
    createOAuthConfiguration(configurationParams: TaskAgentInterfaces.OAuthConfigurationParams): Promise<TaskAgentInterfaces.OAuthConfiguration>;
    deleteOAuthConfiguration(configurationId: number): Promise<TaskAgentInterfaces.OAuthConfiguration>;
    getOAuthConfiguration(configurationId: number): Promise<TaskAgentInterfaces.OAuthConfiguration>;
    getOAuthConfigurations(actionFilter?: TaskAgentInterfaces.OAuthConfigurationActionFilter): Promise<TaskAgentInterfaces.OAuthConfiguration[]>;
    updateOAuthConfiguration(configurationParams: TaskAgentInterfaces.OAuthConfigurationParams, configurationId: number): Promise<TaskAgentInterfaces.OAuthConfiguration>;
    ...
    getDeploymentTargets(project: string, deploymentGroupId: number, tags?: string[], name?: string, partialNameMatch?: boolean, expand?: TaskAgentInterfaces.DeploymentTargetExpands, agentStatus?: TaskAgentInterfaces.TaskAgentStatusFilter, agentJobResult?: TaskAgentInterfaces.TaskAgentJobResultFilter, continuationToken?: string, top?: number): Promise<TaskAgentInterfaces.DeploymentMachine[]>;
    ...
    createAadOAuthRequest(tenantId: string, redirectUri: string, promptOption?: TaskAgentInterfaces.AadLoginPromptOption, completeCallbackPayload?: string): Promise<string>;
...
export class TaskAgentApiBase extends basem.ClientApiBase implements ITaskAgentApiBase {
    ...
    /**
     * @param {TaskAgentInterfaces.OAuthConfigurationParams} configurationParams
     */
    public async createOAuthConfiguration(
        configurationParams: TaskAgentInterfaces.OAuthConfigurationParams
        ): Promise<TaskAgentInterfaces.OAuthConfiguration> {

        return new Promise<TaskAgentInterfaces.OAuthConfiguration>(async (resolve, reject) => {
            let routeValues: any = {
            };
            ...
            try {
                let verData: vsom.ClientVersioningData = await this.vsoClient.getVersioningData(
                    "5.0-preview.1",
                    "distributedtask",
                    "a2fec2cd-3b52-42cb-b0cb-f4c152f3e2b8",
                    routeValues);
                ...
                let res: restm.IRestResponse<TaskAgentInterfaces.OAuthConfiguration>;
                res = await this.rest.create<TaskAgentInterfaces.OAuthConfiguration>(url, configurationParams, options);

                let ret = this.formatResponse(res.result,
                                              TaskAgentInterfaces.TypeInfo.OAuthConfiguration,
                                              false);
    ...
    public async deleteOAuthConfiguration(
        ...
        return new Promise<TaskAgentInterfaces.OAuthConfiguration>(async (resolve, reject) => {
            ...
            try {
                ...
                let res: restm.IRestResponse<TaskAgentInterfaces.OAuthConfiguration>;
                res = await this.rest.del<TaskAgentInterfaces.OAuthConfiguration>(url, options);
    ...
    public async getOAuthConfiguration(
        ...
        return new Promise<TaskAgentInterfaces.OAuthConfiguration>(async (resolve, reject) => {
            ...
            try {
                ...
                let res: restm.IRestResponse<TaskAgentInterfaces.OAuthConfiguration>;
                res = await this.rest.get<TaskAgentInterfaces.OAuthConfiguration>(url, options);
    ...
    /**
     * @param {TaskAgentInterfaces.OAuthConfigurationActionFilter} actionFilter
     */
    public async getOAuthConfigurations(
        actionFilter?: TaskAgentInterfaces.OAuthConfigurationActionFilter
        ): Promise<TaskAgentInterfaces.OAuthConfiguration[]> {
    ...
    public async updateOAuthConfiguration(
        ...
        return new Promise<TaskAgentInterfaces.OAuthConfiguration>(async (resolve, reject) => {
            ...
            try {
                ...
                let res: restm.IRestResponse<TaskAgentInterfaces.OAuthConfiguration>;
                res = await this.rest.replace<TaskAgentInterfaces.OAuthConfiguration>(url, configurationParams, options);
